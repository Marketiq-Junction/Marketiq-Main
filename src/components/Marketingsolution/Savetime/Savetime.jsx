...
const Savetime = () => {
  ...
  return (
    <div className="bg-[#4A9BD3] text-white w-full py-12">
      <div className="flex flex-col md:flex-row items-center max-w-screen-xl mx-auto px-6">
        ...
        <div className="flex flex-col text-center md:text-left md:w-2/3 justify-center px-6">
          ...
          >
            {points.map((point, index) => (
              <motion.li
                ...
                className="flex items-start gap-3"
              >
                <div className="w-6 h-6 flex items-center justify-center bg-white text-[#4A9BD3] font-bold rounded-full shadow-md">
                  ✓
                </div>
                <span className="text-lg text-gray-200 leading-7">{point}</span>
              </motion.li>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center md:justify-start space-y-4 md:space-y-0 md:space-x-4">
            <button
              onClick={handleWhatsAppClick}
              className="bg-white border-2 border-[#4A9BD3] text-black px-8 py-3 rounded-lg shadow-md hover:bg-gray-100 hover:scale-105 transition transform"
            >
              Get in Contact
            </button>
          </div>
