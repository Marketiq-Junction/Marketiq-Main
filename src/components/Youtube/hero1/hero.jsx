        ...
        >
          ...
          <div className="relative w-full sm:w-[400px] md:w-[500px] mt-6">
            <input
              ...
              value={website}
              onChange={(e) => setWebsite(e.target.value)}
              className="w-full py-3 px-4 pr-36 border border-gray-300 text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 rounded-md"
            />
            <button
              onClick={() => {
                handleWhatsAppClick();
                ...
                if (typeof gtag === "function") {
                  gtag("event", "request_audit_click", {
                    event_category: "button",
                    event_label: "Request an Audit Button",
                    value: 1,
                  });
                }
              }}
              className="absolute top-1/2 right-2 transform -translate-y-1/2 bg-[#50C3C6] text-white px-4 py-2 hover:bg-[#4A9BD3] focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-2 rounded-md transition-colors"
            >
              Request an Audit
            </button>
          </div>
