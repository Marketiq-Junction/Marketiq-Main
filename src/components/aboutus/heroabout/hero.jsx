...
// const Hero = () => {
//   return (
//     <div className="bg-[#4A9BD3] text-white pt-24 pb-16 relative">
//       {/* Content Section */}
//       <div className="text-center px-4 mb-12">
//         <h1 className="text-4xl font-bold sm:text-5xl lg:text-6xl mt-8">
//           About Us
//         </h1>
...
const Hero = () => {
  return (
    <div className="bg-[#4A9BD3] text-white pt-24 pb-16 relative overflow-hidden">
      {/* Content Section */}
