...
const DigitalAgency = () => {
  ...
  return (
    <div className="bg-white px-4 sm:px-8 md:px-12 lg:px-16 py-10 md:py-12 lg:py-16">
          ...
          >
            <div className="flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-white mr-3 sm:mr-4">
              {React.cloneElement(card.icon, {
                className: "text-2xl sm:text-3xl text-[#4A9BD3]",
              })}
            </div>
      ...
      {/* Active Content Section */}
      <div className="bg-gray-100 p-4 sm:p-6 md:p-8 rounded-lg shadow-lg flex flex-col md:flex-row items-center gap-6 md:gap-8 border-2 border-black">
        {/* Text Section */}
        <div className="md:w-1/2 text-center md:text-left">
