...
const ServiceCard = ({ service, active, onClick }) => (
  ...
  >
    ...
    {active && (
      <span className="bg-gradient-to-r from-teal-400 to-cyan-500 p-2 rounded-full shadow-lg">
  ...
  return (
    <div className="w-full p-8 bg-white flex flex-col items-center">
      ...
      <div className="w-full flex flex-col md:flex-row justify-between mb-8">
        ...
        >
          <h2 className="text-3xl font-bold bg-gradient-to-r from-teal-500 to-cyan-600 bg-clip-text text-transparent mb-2">
            WHAT WE DO
          </h2>
      ...
      {/* Main Section */}
      <div className="w-full max-w-6xl bg-gradient-to-r from-teal-500 to-cyan-600 rounded-[40px] shadow-xl overflow-hidden">
        <div className="flex flex-col md:flex-row">
          {/* Left Menu */}
          <div className="bg-gradient-to-br from-teal-400 to-cyan-500 p-6 md:w-1/3 flex flex-col space-y-4 overflow-x-auto md:overflow-visible">
