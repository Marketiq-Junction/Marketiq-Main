...
const Offers = () => {
  ...
  return (
    <section className="bg-[#4A9BD3] text-white py-16 px-6 md:px-12">
      <div className="max-w-7xl mx-auto text-center">
        <h3 className="text-xl uppercase text-black font-semibold mb-4">
          What We’re Offering
        </h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-white text-black p-6 rounded-xl shadow-lg transform transition-all duration-300 hover:-translate-y-2 hover:bg-gradient-to-r hover:from-[#4A9BD3] hover:to-[#50C3C6] hover:text-white cursor-pointer"
              onMouseEnter={() => {
                // GA4 event tracking for hover
                if (
