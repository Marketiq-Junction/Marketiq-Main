...
const Testimonial = () => {
  ...
  return (
    <section className="bg-gradient-to-r from-teal-500 to-cyan-600 text-white py-16 px-8 md:py-20 md:px-20 mt-8 rounded-xl shadow-lg">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h3 className="text-xl uppercase font-semibold tracking-wider text-white">
            Testimonials
          </h3>
