      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {auditItems.map((item, index) => (
            <div
              key={index}
              className="relative bg-[#4A9BD3] text-white p-6 shadow-lg rounded-lg transform transition-transform duration-300 hover:-translate-y-2 hover:shadow-xl"
            >
              {/* Icon */}
              <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 w-20 h-20 bg-[#50C3C6] text-blue-500 rounded-full flex items-center justify-center shadow-lg">
                <div className="text-3xl">{item.icon}</div>
        ...
        <div className="text-center mt-12">
          <button
            ...
            className="bg-white text-black py-3 px-6 border-2 border-[#4A9BD3] rounded-lg shadow-lg hover:bg-[#50C3C6] hover:text-white transition duration-300"
          >
            Request a Audit
          </button>
        </div>
