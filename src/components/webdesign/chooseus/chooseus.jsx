    ...
    <section className="bg-[#A2DFE1] py-16">
      <div className="container mx-auto px-6 lg:px-16 flex flex-col lg:flex-row items-start gap-12">
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <h3 className="text-2xl sm:text-3xl font-bold text-gray-700 uppercase mb-4">
            Why Choose Us
          </h3>
          ...
          <ul className="text-base sm:text-lg text-gray-700 space-y-4">
            {pointsLeft.map((point, index) => (
              <motion.li
                key={index}
                className="flex items-start gap-2"
          ...
          >
            <motion.button
              ...
              className="px-6 py-3 bg-[#4A9BD3] text-white font-semibold rounded-md hover:bg-white hover:text-black transition-all duration-300"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              Talk to Us
        ...
        >
          {cardData.map((card, index) => (
            <motion.div
              ...
              transition={{ delay: index * 0.2, duration: 0.5 }}
            >
              <h3 className="text-xl sm:text-2xl font-bold text-[#4A9BD3] mb-3">
                {card.title}
              </h3>
              <ul className="text-gray-700 space-y-2">
                {card.points.map((point, idx) => (
