...
const services = [
  ...
  },
  {
    ...
    icon: <PublicIcon fontSize="large" style={{ color: "#1DA1F2" }} />,
  },
  {
  ...
  },
  {
    ...
    icon: <SearchIcon fontSize="large" style={{ color: "#0F9D58" }} />,
  },
  {
    title: "Analytics & Reporting",
    description: "Track performance and optimize strategies",
    icon: <InsightsIcon fontSize="large" style={{ color: "#673AB7" }} />,
  },
];
      ...
      <div className="container mx-auto px-6 lg:px-16 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-white p-6 rounded-br-3xl rounded-tl-3xl border-4 border-black shadow-lg hover:shadow-2xl hover:shadow-cyan-400/40 transition-all duration-300 transform hover:scale-105 cursor-pointer"
              onClick={() => {
                if (
