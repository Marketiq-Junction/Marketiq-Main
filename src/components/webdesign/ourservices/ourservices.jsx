...
const OurServices = () => {
  return (
    <section className="w-full bg-gradient-to-b from-[#A2DFE1] to-[#4A9BD3] py-16">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-5xl font-bold text-black mb-4">Our Services</h2>
        <p className="text-gray-900 text-xl md:text-2xl max-w-4xl mx-auto mb-12">
          Discover the specialized services crafted to meet your digital needs!
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transform transition duration-300 hover:scale-105 flex flex-col"
            >
              <div className="text-[#4A9BD3] text-5xl mb-4">{service.icon}</div>
              <h3 className="text-2xl font-bold text-[#4A9BD3] mb-4">
                {service.title}
              </h3>
