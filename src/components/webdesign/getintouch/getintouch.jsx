...
const GetInTouch = () => {
  ...
  return (
    <section className="bg-gradient-to-r from-[#4A9BD3] to-[#50C3C6] py-16 lg:mb-28">
      <div className="container mx-auto px-6 lg:px-16">
        <div className="flex flex-col lg:flex-row items-start lg:items-center gap-12">
          ...
          <div className="lg:w-1/2 w-full text-left">
            ...
            <p className="text-base sm:text-lg text-white mb-4">
              ...
              us today, and let’s start crafting the perfect digital strategy
              for your brand. Our team at Marketiq Junction is eager to
              collaborate and provide tailored solutions that meet your unique
              needs.
            </p>
            <p className="text-base sm:text-lg text-white mb-6">
              Don’t wait any longer—let’s embark on this journey together! Fill
              out the form to get started with your next digital transformation.
            </p>
            <button className="bg-transparent text-white hover:text-blue-700 font-semibold border-2 border-white px-6 py-3 rounded-md mt-2 transition duration-300">
              Discover More
            </button>
          </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <input
                  ...
                  onChange={handleChange}
                  placeholder="First Name"
                  className="p-3 border border-gray-300 rounded-md w-full text-black focus:outline-none focus:ring-2 focus:ring-[#4A9BD3]"
                  required
                />
                <input
                  type="text"
              ...
              <div className="flex justify-center">
                <button
                  type="submit"
                  className="bg-[#3F85B5] text-white px-6 py-3 rounded-md font-semibold hover:bg-blue-700 transition duration-300"
                >
                  Submit
                </button>
              </div>
