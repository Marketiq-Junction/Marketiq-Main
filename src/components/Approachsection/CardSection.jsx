...
//     {
//       title: 'OPTIMIZE',
//       imageSrc: '/images/icons/optimize-icon.png', // Replace with actual image path
...
//     {
//       title: 'GENERATE',
//       imageSrc: '/images/icons/generate-icon.png', // Replace with actual image path
...
//     {
//       title: 'GROW',
//       imageSrc: '/images/icons/grow-icon.png', // Replace with actual image path
...
//   return (
//     <div className="relative max-w-screen-lg mx-auto my-10 space-y-8">
//       <div className="absolute top-0 left-0 transform translate-x-6 bg-white p-6 rounded-lg shadow-lg text-center border border-gray-200 w-full md:w-80">
...
//       <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-6 rounded-lg shadow-lg text-center border border-gray-200 w-full md:w-80">
...
//       <div className="absolute bottom-0 right-0 transform -translate-x-6 bg-white p-6 rounded-lg shadow-lg text-center border border-gray-200 w-full md:w-80">
